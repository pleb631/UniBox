...
class TestDataset(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.dataset.anno, [])
    ...
    def test_append(self):
        ...
        self.assertEqual(self.dataset.anno[0], bbox)
    ...
    def test_label_property(self):
        bbox = Bbox([0, 0, 10, 10], "ltrb", True)
        self.dataset.append(bbox)
        self.assertEqual(len(self.dataset.anno), 1)
        self.assertEqual(self.dataset.anno[0], bbox)
    ...
    def test_set_label(self):
        ...
        self.assertEqual(self.dataset.anno[0], bbox2)
    ...
    def test_save(self):
        bbox = Bbox([0, 0, 10, 10], "ltrb", True,"0",[30,30])
        self.dataset.append(bbox)
